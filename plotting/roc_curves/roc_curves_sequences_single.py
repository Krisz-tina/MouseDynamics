...
def main():
    ...
    # print('len X.._0', len(X_validation_0))
    # print('len X.._1', len(X_validation_1))
    ...
    score_file_name = write_to_file(scores_sec_array)
    title = 'ROC curve (AUC) user' + str(settings.USER_ID)
    computeAUC(score_file_name, title)
...
def write_to_file(prediction_results):
    ...
    a = s[index:]
    b = a[::-1]
    file_name = b + str(settings.USER_ID) + '_sequence.csv'
