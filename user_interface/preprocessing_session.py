...
def determine_actions(file_name, file_name_out):
    """ Determine an action, decides if it's appropriate. """

    with open(file_name, 'r') as csv_file:
        data_reader = csv.reader(csv_file, delimiter=',')

        with open(file_name_out, 'w', newline='') as csv_output:
            ...
            header = ['Mouse Action',
                      ...
                      'direction', 'length_of_line', 'largest_deviation', 'User'
                      ]
            data_writer.writerow(header)

            user_name = get_user_name_from_file_name(file_name)
            session = get_session_from_file_name(file_name)
